...
public class CommentLikeServiceImpl implements CommentLikeService {
    ...
    @Override
    public CountCommentLike countCommentLikeService(Long commentId) {
        Long countCommentLikes = commentLikeRepository.countByToComment_Id(commentId);
        return new CountCommentLike(countCommentLikes);
    }
}
