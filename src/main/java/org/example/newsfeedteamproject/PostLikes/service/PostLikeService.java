...
import org.example.newsfeedteamproject.PostLikes.dto.PostCountLike;
...
public class PostLikeService {
    ...
    public PostCountLike countPostLikeService(Long postId) {
        Long countPostLike = postLikeRepository.countByToPostId(postId);
        return new PostCountLike(countPostLike);
    }
}
